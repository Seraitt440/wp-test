...
function business_ezone_content_end(){
    ...
    if( ! is_page_template( 'template-home.php' ) || ! ( is_front_page() && is_page_template( 'template-home.php' ) ) ){
    ...
    echo '<div class="footer-b">';
        echo '<div class="container">'; 
            echo '<div class="site-info">';
                ...
                printf( '&nbsp;%s', '<a href="'. esc_url( __( 'http://prosystheme.com/wordpress-themes/business-ezone/', 'business-ezone' ) ) .'" target="_blank">'. esc_html__( 'Business Ezone By Prosys Theme. ', 'business-ezone' ) .'</a>' );
