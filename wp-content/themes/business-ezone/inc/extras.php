...
function business_ezone_social_link_cb(){	       
  ...
  ?>
	...
	<ul class="header-contact">
		 <?php if( isset($business_ezone_button_url_fb) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_fb ) ?>"><i class="fa fa-facebook"></i></a></li>
		<?php } if( isset($business_ezone_button_url_tw) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_tw ) ?>"><i class="fa fa-twitter"></i></a></li>
		<?php } if( isset($business_ezone_button_url_ln) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_ln ) ?>"><i class="fa fa-linkedin"></i></a></li>
		<?php } if( isset($business_ezone_button_url_ins) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_ins ) ?>"><i class="fa fa-instagram"></i></a></li>
		<?php } if( isset($business_ezone_button_url_gp) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_gp ) ?>"><i class="fa fa-google-plus"></i></a></li>
		<?php } if( isset($business_ezone_button_url_pin) ){?>
		<li><a href="<?php echo esc_url( $business_ezone_button_url_pin ) ?>"><i class="fa fa-pinterest"></i></a></li>
		<?php } if( isset($business_ezone_button_url_yt) ){?>
        <li><a href="<?php echo esc_url( $business_ezone_button_url_yt ) ?>"><i class="fa fa-youtube"></i></a></li>
        <?php } ?>
	</ul>
<?php } 
endif; 
